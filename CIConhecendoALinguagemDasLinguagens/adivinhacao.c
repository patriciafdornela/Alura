...
// Short, Int e Long -> Numeros inteiros
...
//Converter o número para positivo
...
//     int segundos = time(0);
//     srand(segundos); números aleatorios conforme os segundos
...
//     int resultado = rand;
//     int tabuada = resultado % 10; 

//     for (int i = 1; i <= 10; i++)
//     {
//         printf("%d X %d = %d",tabuada , i, tabuada*i);
//     }
// }